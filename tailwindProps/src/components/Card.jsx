...
function Card({username = "Undefined", designation = "NA"}) {
   
    return (
        <>
            <section className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8 rounded-xl mb-4">
